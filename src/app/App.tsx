...
import { ManualAnalysis } from "../components/ui/ManualAnalysis";
import { PricingCard } from "../components/ui/PricingCard";
import { BrowserExtensionPopup } from "../components/ui/BrowserExtensionPopup";
import { PlanSelectionDialog } from "../components/ui/PlanSelectionDialog";
...
function AppContent() {
  ...
  // Use Clerk user when available. Do NOT ship demo account names from Figma.
  const { user } = useUser();
  const userName =
    user?.fullName || user?.primaryEmailAddress?.emailAddress || (language === 'ro' ? 'Utilizator' : 'User');
